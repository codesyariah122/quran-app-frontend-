...
<style lang="scss">
  @font-face {
    font-family: 'quran';
    src: local('quran'), url('./assets/quran-font/amiri-quran-colored.woff') format("truetype");
  }

  @font-face {
    font-family: 'AlQalam';
    src: local('AlQalam'), url('./assets/quran-font/noorehidayat.ttf') format("opentype");
  }
